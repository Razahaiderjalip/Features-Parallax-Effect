...
function FAQ() {
    return (
        <>
            <div className='xl:w-[80%] lg:w-[80%] px-[40px] flex flex-col gap-y-4 mx-auto'>
                <Accordion id="accorditionid1" className='shadow-none' style={{ borderTopWidth: 4, borderColor: "#E5E5E5", borderBottomWidth: 0, marginBottom: 10 }}>
                    <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="panel1a-content"  id="faq">
                ...
                <Accordion className='shadow-none' style={{ borderTopWidth: 4, borderColor: "#E5E5E5", borderBottomWidth: 0, marginBottom: 10 }}>
                    ...
                    <AccordionDetails>
                        <Typography className="pr-24  xsm:pr-2 sm:pr-2 md:pr-2 ">
