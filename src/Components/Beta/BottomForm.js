...
function BottomForm({ title }) {
    ...
    return (
        <div style={{
        ...
        }} className="bottomform py-10 flex flex-row sm:flex-col relative  sm:py-6 ">
            <img src={bubble2} alt="bubble" className='object-contain absolute  top-0 right-0 mr-24 mt-16 ' />
            <img src={bubble1} alt="bubble" className='object-contain absolute  h-[250px]  top-0 right-0 mt-40' />
            <img src={bubble3} alt="bubble" className='object-contain absolute  bottom-0 left-0 m-10' />
            ...
            <div className="w-[78.5%] lg:w-[90%] xmd:w-[95%] md:w-[95%] px-[40px] flex flex-row xsm:w-full xsm:flex-col sm:w-full sm:flex-col md:flex-col xmd:flex-col gap-y-6 gap-x-2  mx-auto py-14 relative xsm:mx-0 sm:mx-0">
                ...
                <div className='w-1/3 xsm:w-full sm:w-full md:w-full  xmd:w-full flex flex-col  ' >
                    <p className='text-white Brevia850 not-italic font-black text-5xl sm:text-3xl leading-[65px] '>Compila il form <br></br>per essere contattato per l’accesso anticipato!</p>
